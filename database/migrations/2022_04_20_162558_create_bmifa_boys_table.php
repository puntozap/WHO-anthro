...
class CreateBmifaBoysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bmifa_boys', function (Blueprint $table) {
            $table->id();
        ...
        $file=public_path()."/z-score/Body mass inder-for-age (BMI-for-age)/bfa-boys-zscore-expanded-tables.csv";
        //dd($file);
        $customerArr = $this->csvToArray($file);
        //dd($customerArr);
        foreach($customerArr as $custom){
            DB::table('bmifa_boys')->insert([
                'day' => $custom["Day"],
        ...
        print("bfa-boys-zscore-expanded-tables.csv uploaded");
    }
    ...
    {
        Schema::dropIfExists('bmifa_boys');
    }
