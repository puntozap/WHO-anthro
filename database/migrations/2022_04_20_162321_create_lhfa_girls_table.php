...
class CreateLhfaGirlsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lhfa_girls', function (Blueprint $table) {
            $table->id();
        ...
        $file=public_path()."/z-score/Length-height-for-age/lhfa-girls-zscore-expanded-tables.csv";
        //dd($file);
        $customerArr = $this->csvToArray($file);
        //dd($customerArr);
        foreach($customerArr as $custom){
            DB::table('lhfa_girls')->insert([
                'day' => $custom["Day"],
        ...
        print("lhfa-girls-zscore-expanded-tables.csv uploaded");
    }
    ...
    {
        Schema::dropIfExists('lhfa_girls');
    }
