...
class CreateWfaBoysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wfa_boys', function (Blueprint $table) {
            $table->id();
        ...
        $file=public_path()."/z-score/Weight-for-age/wfa-boys-zscore-expanded-tables.csv";
        //dd($file);
        $customerArr = $this->csvToArray($file);
        //dd($customerArr);
        foreach($customerArr as $custom){
            DB::table('wfa_boys')->insert([
                'day' => $custom["Day"],
        ...
        print("wfa-boys-zscore-expanded-tables.csv uploaded");
    }
