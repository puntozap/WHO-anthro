...
class CreateWflGirlsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wfl_girls', function (Blueprint $table) {
            $table->id();
        ...
        //dd($file);
        $file=public_path()."/z-score/Weight-for-length-height/wfl-girls-zscore-expanded-table.csv";
        $customerArr = $this->csvToArray($file);
        //dd($customerArr);
        foreach($customerArr as $custom){
            DB::table('wfl_girls')->insert([
        ...
        print("wfl-girls-zscore-expanded-table.csv uploaded");
    }
