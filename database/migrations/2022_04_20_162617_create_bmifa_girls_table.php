...
class CreateBmifaGirlsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bmifa_girls', function (Blueprint $table) {
            $table->id();
        ...
        $file=public_path()."/z-score/Body mass inder-for-age (BMI-for-age)/bfa-girls-zscore-expanded-tables.csv";

        //dd($file);
        $customerArr = $this->csvToArray($file);

        foreach($customerArr as $custom){
            DB::table('bmifa_girls')->insert([
                'day' => $custom["Day"],
        ...
        print("bfa-girls-zscore-expanded-tables.csv uploaded");
    }
    ...
    {
        Schema::dropIfExists('bmifa_girls');
    }
